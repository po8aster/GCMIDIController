...
//Change number to correspond to desired MIDI Note (ie Middle C = 60). Z holds in synth mode will be 1 half-step down from whatever you map the root button to.
